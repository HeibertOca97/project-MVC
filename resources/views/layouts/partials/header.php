            ...
            <?php if ($this->AuthCheck()): ?>
                ...
                <div class="box-tools">
                    ...
                    <div class="link-item-opt">
                        ...
                        <a href="<?= $this->route("auth/logout")  ?>" class="item-opt2 link-cl2"><i class="fas fa-door-open"></i><span>Log out</span></a>
                    </div>
                </div>
            <?php else: ?>
                <a href="<?= $this->route("login")  ?>" class="link-item <?= $this->checkRoute('login') ? 'link-active' : 'link-cl1'; ?>">Sign in</a>
                <a href="<?= $this->route("register")  ?>" class="link-item <?= $this->checkRoute('register') ? 'link-active' : 'link-cl1'; ?>">Sign up</a>
            <?php endif; ?>
        </div>
    </nav>
</header>
